...
export const routes: Routes = [
  ...
  {
    path: 'patients',
    loadComponent: () => import('./features/appointments/components/patientdetails-comp/patientdetails-comp').then(m => m.PatientdetailsComp)
  },
  {
    path: 'afterpayment',
    loadComponent: () => import('./features/appointments/components/afterpayment-comp/afterpayment-comp').then(m => m.AfterpaymentComp)
  },
  {
    path: 'unauthorized',
